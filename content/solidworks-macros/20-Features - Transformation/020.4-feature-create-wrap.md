...
url: /solidworks-vba-macros/create-wrap/
weight: 61
---
...
[![wrap-feature-final-result](feature-wrap/final-result-gif.gif)](feature-wrap/final-result-gif.gif)
...
[![prerequisite](feature-wrap/prerequisite.png)](feature-wrap/prerequisite.png)
...
[![message-to-select-wrap-sketch](feature-wrap/message-to-select-wrap-sketch.png)](feature-wrap/message-to-select-wrap-sketch.png)

* Below image shows the message for **Face selection** to the user.

[![message-to-select-wrap-face](feature-wrap/message-to-select-wrap-face.png)](feature-wrap/message-to-select-wrap-face.png)
...
* In above line of code we are doing **2 steps** in one line.
  ...
  * **Step 1** - Getting **Wrap thickness** from user.
  ...
  [![message-to-enter-wrap-thickness](feature-wrap/message-to-enter-wrap-thickness.png)](feature-wrap/message-to-enter-wrap-thickness.png)
...
* When this condition is **`True`**, 
  ...
  * **Message**: *Empty or no value. Please try again.*
  ...
  [![message-to-show-when-empty-or-no-value-given](feature-wrap/message-to-show-when-empty-or-no-value-given.png)](feature-wrap/message-to-show-when-empty-or-no-value-given.png)
...
* **Condition**: **`IsNumeric(response) = False`**
  * **`IsNumeric()`** is pre-build VBA function which check if *passing object is **Numeric** or not*.
  ...
  [![entering-non-numeric-value](feature-wrap/entering-non-numeric-value.png)](feature-wrap/entering-non-numeric-value.png)
...
* When this condition is **`True`**, 
  ...
  * **Message**: *Entered value is Non-numeric. Please try again.*
  ...
  [![message-to-show-non-numeric-value-given](feature-wrap/message-to-show-non-numeric-value-given.png)](feature-wrap/message-to-show-non-numeric-value-given.png)
...
[![entering-zera-as-value](feature-wrap/entering-zera-as-value.png)](feature-wrap/entering-zera-as-value.png)

* When this condition is **`True`**, 
  * We show and 🚀 **[message window](/vba/msgBox-function/)** to user.
  * **Message**: *Entered value must be greater than 0. Please try again.*

  [![message-to-show-on-zero-given](feature-wrap/message-to-show-on-zero-given.png)](feature-wrap/message-to-show-on-zero-given.png)
