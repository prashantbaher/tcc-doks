...
url: /solidworks-vba-macros/create-rib/
weight: 58
---
...
[![Rib Feature final result](feature-rib/final-result-gif.gif)](feature-rib/final-result-gif.gif)
...
[![prerequisite](feature-rib/prerequisite.png)](feature-rib/prerequisite.png)
...
* In above line of code we are doing **2 steps** in one line.
  ...
  * **Step 1** - Getting **Rib Thickness** from user.
  ...
  [![message-to-select-rib-thickness](feature-rib/message-to-select-rib-thickness.png)](feature-rib/message-to-select-rib-thickness.png)
