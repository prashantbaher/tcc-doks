...
url: /solidworks-vba-macros/create-draft/
weight: 59
---
...
[![draft-feature-final-result](feature-draft/final-result-gif.gif)](feature-draft/final-result-gif.gif)
...
[![prerequisite](feature-draft/prerequisite.png)](feature-draft/prerequisite.png)
...
[![message-to-select-neutral-face](feature-draft/message-to-select-neutral-face.png)](feature-draft/message-to-select-neutral-face.png)

* Below image shows the message for **Faces for Draft** to the user.

[![message-to-select-draft-face](feature-draft/message-to-select-draft-face.png)](feature-draft/message-to-select-draft-face.png)
...
* In above line of code we are doing **2 steps** in one line.
  ...
  * **Step 1** - Getting **Draft Angle** from user.
  ...
  [![message-to-enter-draft-angle](feature-draft/message-to-enter-draft-angle.png)](feature-draft/message-to-enter-draft-angle.png)
