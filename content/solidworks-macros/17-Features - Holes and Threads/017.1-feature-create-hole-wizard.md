...
url: /solidworks-macros/create-hole-from-hole-wizard/
weight: 50
---
...
[![hole-wizard-final-result](hole-wizard/hole-wizard-final-result.png)](hole-wizard/hole-wizard-final-result.png)
...
[![prerequisite](hole-wizard/prerequisite.png)](hole-wizard/prerequisite.png)
...
[![ask-user-to-select-sketch](hole-wizard/ask-user-to-select-sketch.png)](hole-wizard/ask-user-to-select-sketch.png)
...
[![hole-wizard-parameters](hole-wizard/hole-wizard-parameters.png)](hole-wizard/hole-wizard-parameters.png)
