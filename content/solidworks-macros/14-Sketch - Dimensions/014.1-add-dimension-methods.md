...
url: /solidworks-macros/add-dimension-methods/
weight: 41
---
...
![before-add-dimension](dimensions/before-add-dimension.png)

**After Circular Sketch Pattern**

![after-add-dimension](dimensions/after-add-dimension.png)
