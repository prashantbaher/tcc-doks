...
url: /solidworks-macros/create-mirror/
weight: 54
---
...
[![mirror-final-result](feature-mirror/mirror-final-result.png)](feature-mirror/mirror-final-result.png)
...
[![prerequisite](feature-mirror/prerequisite.png)](feature-mirror/prerequisite.png)
...
[![message-to-select-feature-for-mirror](feature-mirror/message-to-select-feature-for-mirror.png)](feature-mirror/message-to-select-feature-for-mirror.png)

Below image shows the message for **Plane selection** to the user.

[![message-to-select-plane-for-mirror](feature-mirror/message-to-select-plane-for-mirror.png)](feature-mirror/message-to-select-plane-for-mirror.png)
