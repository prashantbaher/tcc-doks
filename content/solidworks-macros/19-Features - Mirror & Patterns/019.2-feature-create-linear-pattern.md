...
url: /solidworks-macros/create-linear-patterns/
weight: 55
---
...
[![linear-pattern-final-result](feature-linear-pattern/linear-pattern-final-result.png)](feature-linear-pattern/linear-pattern-final-result.png)
...
[![prerequisite](feature-linear-pattern/prerequisite.png)](feature-linear-pattern/prerequisite.png)
...
[![message-to-select-feature-for-linear-pattern](feature-linear-pattern/message-to-select-feature-for-linear-pattern.png)](feature-linear-pattern/message-to-select-feature-for-linear-pattern.png)

Below image shows the message for **first Edge for Direction 1** to the user.

[![message-to-select-edge-for-direction-1](feature-linear-pattern/message-to-select-edge-for-direction-1.png)](feature-linear-pattern/message-to-select-edge-for-direction-1.png)

Below image shows the message for **second Edge for Direction 2** to the user.

[![message-to-select-edge-for-direction-2](feature-linear-pattern/message-to-select-edge-for-direction-2.png)](feature-linear-pattern/message-to-select-edge-for-direction-2.png)
...
[![message-to-select-spacing-for-direction-1](feature-linear-pattern/message-to-select-spacing-for-direction-1.png)](feature-linear-pattern/message-to-select-spacing-for-direction-1.png)
...
[![message-to-select-number-of-instance-for-direction-1](feature-linear-pattern/message-to-select-number-of-instance-for-direction-1.png)](feature-linear-pattern/message-to-select-number-of-instance-for-direction-1.png)
...
[![message-to-select-spacing-for-direction-2](feature-linear-pattern/message-to-select-spacing-for-direction-2.png)](feature-linear-pattern/message-to-select-spacing-for-direction-2.png)
...
[![message-to-select-number-of-instance-for-direction-2](feature-linear-pattern/message-to-select-number-of-instance-for-direction-2.png)](feature-linear-pattern/message-to-select-number-of-instance-for-direction-2.png)
