...
url: /solidworks-vba-macros/create-circular-patterns/
weight: 56
---
...
[![circular-pattern-final-result](feature-circular-pattern/final-result-gif.gif)](feature-circular-pattern/final-result-gif.gif)
...
[![prerequisite](feature-circular-pattern/prerequisite.png)](feature-circular-pattern/prerequisite.png)
...
[![message-to-select-feature-for-circular-pattern](feature-circular-pattern/message-to-select-feature-for-circular-pattern.png)](feature-circular-pattern/message-to-select-feature-for-circular-pattern.png)

* Below image shows the message for **Edge for Direction 1** to the user.

[![message-to-select-edge-for-direction-1](feature-circular-pattern/message-to-select-edge-for-direction-1.png)](feature-circular-pattern/message-to-select-edge-for-direction-1.png)
...
[![message-to-select-spacing-for-direction-1](feature-circular-pattern/message-to-select-spacing-for-direction-1.png)](feature-circular-pattern/message-to-select-spacing-for-direction-1.png)
...
[![message-to-select-spacing-for-direction-2](feature-circular-pattern/message-to-select-spacing-for-direction-2.png)](feature-circular-pattern/message-to-select-spacing-for-direction-2.png)
...
[![message-to-select-number-of-instance-for-direction-1](feature-circular-pattern/message-to-select-number-of-instance-for-direction-1.png)](feature-circular-pattern/message-to-select-number-of-instance-for-direction-1.png)
...
[![message-to-select-number-of-instance-for-direction-2](feature-circular-pattern/message-to-select-number-of-instance-for-direction-2.png)](feature-circular-pattern/message-to-select-number-of-instance-for-direction-2.png)
