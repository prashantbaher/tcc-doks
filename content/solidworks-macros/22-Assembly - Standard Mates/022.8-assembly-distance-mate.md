...
url: /solidworks-vba-macros/assembly-distance-mate/
weight: 74
---
...
[![assembly-distance-mate](assembly-distance-mate/final-result-gif.gif)](assembly-distance-mate/final-result-gif.gif)
...
[![prerequisite](assembly-distance-mate/prerequisite.gif)](assembly-distance-mate/prerequisite.gif)
...
* We do this in following steps.
  ...
  [![user-confirmation](assembly-tangent-mate/user-confirmation.png)](assembly-tangent-mate/user-confirmation.png)
...
* In above line of code we are doing **2 steps** in one line.
  ...
  * **Step 1** - Getting **Distance** from user.
  ...
  [![message-to-select-distance](assembly-distance-mate/message-to-select-distance.png)](assembly-distance-mate/message-to-select-distance.png)
