...
url: /solidworks-vba-macros/assembly-angle-mate/
weight: 75
---
...
[![assembly-angle-mate](assembly-angle-mate/final-result-gif.gif)](assembly-angle-mate/final-result-gif.gif)
...
[![prerequisite](assembly-angle-mate/prerequisite.gif)](assembly-angle-mate/prerequisite.gif)
...
* We do this in following steps.
  ...
  [![user-confirmation](assembly-angle-mate/user-confirmation.png)](assembly-angle-mate/user-confirmation.png)
...
* In above line of code we are doing **2 steps** in one line.
  ...
  * **Step 1** - Getting **Angle** from user.
  ...
  [![message-to-select-angle](assembly-angle-mate/message-to-select-angle.png)](assembly-angle-mate/message-to-select-angle.png)
