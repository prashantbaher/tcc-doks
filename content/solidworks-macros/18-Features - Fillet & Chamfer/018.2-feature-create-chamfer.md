...
url: /solidworks-macros/create-chamfer/
weight: 53
---
...
[![chamfer-final-result](feature-chamfer/chamfer-final-result.png)](feature-chamfer/chamfer-final-result.png)
...
[![prerequisite](feature-chamfer/prerequisite.png)](feature-chamfer/prerequisite.png)
...
[![message to use for edge selection](feature-chamfer/select-edge-message.png)](feature-chamfer/select-edge-message.png)
...
[![message to use for Chamfer Width input](feature-chamfer/chamfer-width-input-box.png)](feature-chamfer/chamfer-width-input-box.png)
...
[![message to use for Chamfer Angle input](feature-chamfer/chamfer-angle-input-box.png)](feature-chamfer/chamfer-angle-input-box.png)
