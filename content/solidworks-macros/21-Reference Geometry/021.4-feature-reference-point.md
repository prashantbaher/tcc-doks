...
url: /solidworks-vba-macros/create-reference-point/
weight: 66
---
...
[![reference-coordinate-feature-final-result](reference-coordinate/final-result-gif.gif)](reference-coordinate/final-result-gif.gif)
...
[![message-to-select-point](reference-coordinate/message-to-select-point.png)](reference-coordinate/message-to-select-point.png)
...
* In above line of code we are doing **2 steps** in one line.
  ...
  * **Step 1** - Getting **Number of Points** from user.
  ...
  [![message-to-enter-scale-factor](feature-scale/message-to-enter-scale-factor.png)](feature-scale/message-to-enter-scale-factor.png)
...
* When this condition is **`True`**, 
  ...
  * **Message**: *Empty or no value. Please try again.*
  ...
  [![message-to-show-when-empty-or-no-value-given](feature-scale/message-to-show-when-empty-or-no-value-given.png)](feature-scale/message-to-show-when-empty-or-no-value-given.png)
...
* **Condition**: **`IsNumeric(response) = False`**
  * **`IsNumeric()`** is pre-build VBA function which check if *passing object is **Numeric** or not*.
  ...
  [![entering-non-numeric-value](feature-scale/entering-non-numeric-value.png)](feature-scale/entering-non-numeric-value.png)
...
* When this condition is **`True`**, 
  ...
  * **Message**: *Entered value is Non-numeric. Please try again.*
  ...
  [![message-to-show-non-numeric-value-given](feature-scale/message-to-show-non-numeric-value-given.png)](feature-scale/message-to-show-non-numeric-value-given.png)
...
[![entering-zera-as-value](feature-scale/entering-zera-as-value.png)](feature-scale/entering-zera-as-value.png)

* When this condition is **`True`**, 
  * We show and 🚀 **[message window](/vba/msgBox-function/)** to user.
  * **Message**: *Entered value must be greater than 0. Please try again.*

  [![message-to-show-on-zero-given](feature-scale/message-to-show-on-zero-given.png)](feature-scale/message-to-show-on-zero-given.png)
