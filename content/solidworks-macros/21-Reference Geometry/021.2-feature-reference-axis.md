...
url: /solidworks-vba-macros/create-reference-axis/
weight: 64
---
...
[![scale-feature-final-result](reference-axis/final-result-gif.gif)](reference-axis/final-result-gif.gif)
...
[![failed-to-create-plane](reference-axis/failed-to-create-axis.png)](common/failed-to-create-axis.png)
