...
url: /solidworks-vba-macros/create-reference-plane/
weight: 63
---
...
[![scale-feature-final-result](reference-plane/final-result-gif.gif)](reference-plane/final-result-gif.gif)
...
* In above line of code we are doing **2 steps** in one line.
  ...
  * **Step 1** - Getting **Distance** from user.
  ...
  [![message-to-enter-distance](reference-plane/message-to-enter-distance.png)](reference-plane/message-to-enter-distance.png)
...
* When this condition is **`True`**, 
  ...
  * **Message**: *Empty or no value. Please try again.*
  ...
  [![message-to-show-when-empty-or-no-value-given](reference-plane/message-to-show-when-empty-or-no-value-given.png)](reference-plane/message-to-show-when-empty-or-no-value-given.png)
...
* **Condition**: **`IsNumeric(response) = False`**
  * **`IsNumeric()`** is pre-build VBA function which check if *passing object is **Numeric** or not*.
  ...
  [![entering-non-numeric-value](reference-plane/entering-non-numeric-value.png)](reference-plane/entering-non-numeric-value.png)
...
* When this condition is **`True`**, 
  ...
  * **Message**: *Entered value is Non-numeric. Please try again.*
  ...
  [![message-to-show-non-numeric-value-given](reference-plane/message-to-show-non-numeric-value-given.png)](reference-plane/message-to-show-non-numeric-value-given.png)
...
[![entering-zera-as-value](reference-plane/entering-zera-as-value.png)](reference-plane/entering-zera-as-value.png)

* When this condition is **`True`**, 
  * We show and 🚀 **[message window](/vba/msgBox-function/)** to user.
  * **Message**: *Entered value must be greater than 0. Please try again.*

  [![message-to-show-on-zero-given](reference-plane/message-to-show-on-zero-given.png)](reference-plane/message-to-show-on-zero-given.png)
...
[![error-solidworks-document-not-open](common/error-solidworks-document-not-open.png)](common/error-solidworks-document-not-open.png)

**Cause**: Cause of this error is **not** setting **File Location setting** for **Document Templates**.

Please see below image for detail.

[![document-template-setting](common/document-template-setting.png)](common/document-template-setting.png)
...
[![failed-to-create-plane](common/failed-to-create-plane.png)](common/failed-to-create-plane.png)
...
[![plane-names](common/plane-names.png)](common/plane-names.png)
...
[![plane-names-with-suffix-plane](common/plane-names-with-suffix-plane.png)](common/plane-names-with-suffix-plane.png)
