...
url: /solidworks-vba-macros/assembly-rename-mate/
weight: 78
---
...
[![assembly-rename-mate](assembly-rename-mate/final-result-gif.gif)](assembly-rename-mate/final-result-gif.gif)
...
[![prerequisite](assembly-rename-mate/prerequisite.gif)](assembly-rename-mate/prerequisite.gif)
...
* In above line of code we are doing **2 steps** in one line.
  ...
  Those 2 steps are explained below.
    ...
    * **Step 1** - Getting **New Name** from user.
    ...
    [![message-for-new-name](assembly-rename-mate/message-for-new-name.png)](assembly-rename-mate/message-for-new-name.png)
