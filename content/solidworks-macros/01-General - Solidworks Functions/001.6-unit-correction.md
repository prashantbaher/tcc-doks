...
url: /solidworks-macros/unit-correction/
weight: 6
---
...
For more information please visit 🚀 **{{< target-blank "Solidworks Macros - Open new Part document" "/solidworks-macros/open-new-document/" >}}** post.
...
To see methods and properties related to `SketchManager` object, please visit 🚀 **{{< target-blank "this page" "https://help.solidworks.com/2025/english/api/sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchManager_members.html" >}}**
...
To see methods and properties related to `swSketchSegment` object, please visit 🚀 **{{< target-blank "this page" "http://help.solidworks.com/2025/English/api/sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchSegment_members.html" >}}**
...
For **detailed information** about these lines please visit 🚀 **{{< target-blank "Solidworks Macros - Open new Part document" "/solidworks-macros/open-new-document" >}}** post.

I have discussed them **thoroghly** in 🚀 **{{< target-blank "Solidworks Macros - Open new Part document" "/solidworks-macros/open-new-document" >}}** post, so do checkout that post if you want to understand above code in more detail.
...
If you want to know more about `Select Case` statment then please visit  🚀 **{{< target-blank "If-Then and Select Case structure" "/vba/if-then-structure-select-case" >}}** post.
...
For more information about selection method please visit 🚀 **{{< target-blank "Solidworks Macros - Selection Methods" "/solidworks-macros/select-plane-from-tree" >}}** post.
...
For more information about `CreateCircleByRadius` method, you can read my 🚀 **{{< target-blank "Solidworks Macro - Create Circle By Radius From VBA Macro" "/solidworks-macros/create-circle-by-radius" >}}** post.
...
![correct-unit-values](other-images/correct-unit-values.png)
...
If you want to read more about **Option Explicit** then please visit 🚀 **{{< target-blank "Declaring and Scoping of Variables" "/vba/declaring-and-scoping-of-variables" >}}**.

2. Then we create **variable** for different data types.

If you know in detail about the **Variables**, then please visit 🚀 **{{< target-blank "Variables" "/vba/vba-variables" >}}** and 🚀 **{{< target-blank "Data-types" "/vba/vba-programming-concepts-comments-and-datatypes" >}}** posts of this blog.

It will help you to understand what **Variables** are and how to use them.

3. Then we create **main Sub procedure** for our macro.

If you know in detail about the **Sub procedure**, then I suggest you to visit 🚀 **{{< target-blank "VBA Sub and Function Procedures" "/vba/vba-sub-and-function-procedure" >}}** and 🚀 **{{< target-blank "Executing Sub and Function Procedures" "/vba/vba-executing-procedures" >}}** posts of this blog.
...
If you don't know about the **functions**, then you should visit 🚀 **{{< target-blank "VBA Functions" "/vba/vba-functions" >}}** and 🚀 **{{< target-blank "VBA Functions that do more" "/vba/vba-more-function" >}}** posts of this blog.
...
If you want to read more about **Select Case** then please visit 🚀 **{{< target-blank "If-Then and Select Case structure" "/vba/vba-if-then-structure-select-case" >}}**.
...
- **Solidworks Application Object**
  ...
  If you want explore ***Properties and Methods/Functions*** of **Solidworks Application Object** object you can visit 🚀 **{{< target-blank "this link" "http://help.solidworks.com/2025/english/api/sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISldWorks_members.html" >}}**.

- **Solidworks Document Object**

  If you want explore ***Properties and Methods/Functions*** of **Solidworks Document Object** object you can visit 🚀 **{{< target-blank "this link" "http://help.solidworks.com/2025/english/api/sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2_members.html" >}}**.

- **Solidworks Sketch Manager Object**

  If you want explore ***Properties and Methods/Functions*** of **Solidworks Sketch Manager Object** you can visit 🚀 **{{< target-blank "this link" "http://help.solidworks.com/2017/english/api/sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchManager_members.html" >}}**.

- **Solidworks Sketch Segment Object**

  If you want explore ***Properties and Methods/Functions*** of **Solidworks Sketch Segment Object** you can visit 🚀 **{{< target-blank "this link" "http://help.solidworks.com/2025/English/api/sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchSegment_members.html" >}}**.
