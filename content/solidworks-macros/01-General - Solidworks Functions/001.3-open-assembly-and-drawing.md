...
url: /solidworks-macros/open-assembly-and-drawing/
weight: 3
---
...
As you can see in the above code and the code is given in the 🚀 **{{< target-blank "previous post" "/solidworks-macros/open-new-document" >}}** is almost identically.

In case you have not read my 🚀 **{{< target-blank "Solidworks Macros - Open new Part document" "/solidworks-macros/open-new-document" >}}**, I recommend you to read that post first.
...
You can use other values from 🚀 **{{< target-blank "this list" "[http://help.solidworks.com/2025/English/api/swconst/SolidWorks.Interop.swconst~SolidWorks.Interop.swconst.swDwgPaperSizes_e.html](http://help.solidworks.com/2025/English/api/swconst/SolidWorks.Interop.swconst~SolidWorks.Interop.swconst.swDwgPaperSizes_e.html)" >}}**.
