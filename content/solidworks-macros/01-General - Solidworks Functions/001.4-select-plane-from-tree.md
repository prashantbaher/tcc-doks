...
url: /solidworks-macros/select-plane-from-tree/
weight: 4
---
...
To select the plane, I have to add 2 lines.
1st I create a boolean varible above main function as shown in below code.
...
Most of the things in this code sample is already explained 🚀 **{{< target-blank "previous post" "/solidworks-macros/open-new-document" >}}** and in previous section of this very post.
...
Since it is updated and has additional functionality, I will explain it I frequently use this method.
Previous method is easiest method, by far, for selecting objects.
...
As you can see from the above code sample, this method is a method of `Extension` interface or object.

This `Extension` interface or object is part of `swDoc` variable.
This variable is the type of `ModelDoc2` interface or object.
...
- Callout : Pointer to the `Callout` interface or object. Default value most of the time is `Nothing`.
...
There is a lot more about this method in the Remark section.
For more information visit the SolidWorks API help page.
