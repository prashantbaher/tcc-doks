...
![polygon-inscribed-circle-true](arcs/polygon-inscribed-circle-true.png)

Below Image show when *Inscribed* option is `False`and show a *circumscribed construction circle*.

![polygon-inscribed-circle-false](arcs/polygon-inscribed-circle-false.png)
