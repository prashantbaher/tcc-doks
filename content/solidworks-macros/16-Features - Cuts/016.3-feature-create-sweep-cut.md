...
url: /solidworks-macros/create-sweep-cut-feature/
weight: 48
---
...
[![final-result-sweep-cut](feature-sweep-cut/final-result-sweep-cut.png)](feature-sweep-cut/final-result-sweep-cut.png)

- When user select **Incorrect Profile and Path**, we will have result as shown in below image.

[![failed-to-create-sweep-cut](feature-sweep-cut/failed-to-create-sweep-cut.png)](feature-sweep-cut/failed-to-create-sweep-cut.png)
...
[![prerequisite](feature-sweep-cut/prerequisite.png)](feature-sweep-cut/prerequisite.png)
...
[![message-to-select-profile](feature-sweep-cut/message-to-select-profile.png)](feature-sweep-cut/message-to-select-profile.png)
