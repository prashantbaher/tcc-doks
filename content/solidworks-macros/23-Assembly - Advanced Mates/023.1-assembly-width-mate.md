...
url: /solidworks-vba-macros/assembly-width-mate/
weight: 76
---
...
[![assembly-width-mate](assembly-width-mate/final-result-gif.gif)](assembly-width-mate/final-result-gif.gif)
...
[![prerequisite](assembly-width-mate/prerequisite.gif)](assembly-width-mate/prerequisite.gif)
...
[![width-mate-type](assembly-width-mate/width-mate-type.png)](assembly-width-mate/width-mate-type.png)
...
Since 🚀 **[Solidworks Face object](https://help.solidworks.com/2019/english/api/sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFace2_members.html)** is also an 🚀 **[Solidworks Entity object](https://help.solidworks.com/2019/english/api/sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IEntity_members.html)**, we can use methods from 🚀 **[Solidworks Entity object](https://help.solidworks.com/2019/english/api/sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IEntity_members.html)**.<br>
{: .notice--warning}
...
* We do this in following steps.
  * Show a Message Box to user as shown below.
  ...
  [![user-confirmation](assembly-width-mate/user-confirmation.png)](assembly-width-mate/user-confirmation.png)
