...
url: /solidworks-macros/circular-skech-pattern/
weight: 35
---
...
![circular-sketch-pattern-parameters](sketch-patterns/circular-sketch-pattern-parameters.png)
...
![before-circular-pattern](sketch-patterns/before-circular-pattern.png)

**After Circular Sketch Pattern**

![after-circular-pattern](sketch-patterns/after-circular-pattern.png)
