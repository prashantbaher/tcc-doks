...
url: /solidworks-macros/edit-linear-skech-pattern/
weight: 34
---
...
![after-linear-pattern](sketch-patterns/after-linear-pattern.png)

**After Edit Linear Sketch Pattern**

![edit-linear-pattern-numX](sketch-patterns/edit-linear-pattern-numX.png)
...
![edit-linear-pattern-numY](sketch-patterns/edit-linear-pattern-numY.png)
...
![edit-linear-pattern-angleX](sketch-patterns/edit-linear-pattern-angleX.png)
...
![edit-linear-pattern-angleX](sketch-patterns/edit-linear-pattern-angleY.png)
...
![edit-linear-pattern-deleteInstances](sketch-patterns/edit-linear-pattern-deleteInstances.png)
...
![edit-linear-pattern-YSpacingDim](sketch-patterns/edit-linear-pattern-YSpacingDim.png)
...
![edit-linear-pattern-AngleDim](sketch-patterns/edit-linear-pattern-AngleDim.png)
...
![edit-linear-pattern-CreateNumOfInstancesDimInXDir](sketch-patterns/edit-linear-pattern-CreateNumOfInstancesDimInXDir.png)
...
![edit-linear-pattern-CreateNumOfInstancesDimInXDir](sketch-patterns/edit-linear-pattern-CreateNumOfInstancesDimInYDir.png)
