...
title:  Solidworks VBA Macro - Create Standard 3 View [1st Angle]
permalink: /solidworks-vba-macros/drawing-1stangle-standard3views/
tags:   [Solidworks Macro]
---

## Objective

In this article, we understand "how to" **Create Standard 3 View [1st Angle]** in **Drawing document** from VBA macro.
...
[![drawing-1st-angle-standardviews](drawing-1st-angle-standardviews/final-result-gif.gif)](drawing-1st-angle-standardviews/final-result-gif.gif)
...
Below 🎬 video shows how to **Create Standard 3 View [1st Angle]** from *SOLIDWORKS VBA Macros*.

<iframe src="https://www.youtube.com/embed/lrcGGsFqWyc" frameborder="0" allowfullscreen></iframe>
<br>
...
[![prerequisite](drawing-1st-angle-standardviews/prerequisite.png)](drawing-1st-angle-standardviews/prerequisite.png)
...
* **Return Value** : This `Create1stAngleViews2` method return 🚀 **`True`** if successful, **`False`** if not.
...
* **Reference**: For more details please visit 🚀 **[online SOLIDWORKS API Help](https://help.solidworks.com/2019/english/api/sldworksapi/solidworks.interop.sldworks~solidworks.interop.sldworks.idrawingdoc~Create1stAngleViews2.html)**.
