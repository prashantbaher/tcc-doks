...
url: /solidworks-macros/split-sketch-segments/
weight: 901
---
...
![close-segment-before-split](split-sketch-segments/close-segment-before-split.png)

**After Circular Sketch Pattern**

![close-segment-after-split](split-sketch-segments/close-segment-after-split.png)
...
[![open-segment-before-split](split-sketch-segments/open-segment-before-split.png)](split-sketch-segments/open-segment-before-split.png)

**After Circular Sketch Pattern**

[![open-segment-after-split](split-sketch-segments/open-segment-after-split.png)](split-sketch-segments/open-segment-after-split.png)
