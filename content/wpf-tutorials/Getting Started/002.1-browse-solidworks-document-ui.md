...
- ***We will continue from previous article 🚀 {{< target-blank "Add Syncfusion Busy Indicator" "/wpf-tutorials/browse-solidworks-document-ui/" >}}.***
...
![add-WindowStartupLocation-property](browse-solidworks-document-ui/add-WindowStartupLocation-property.png)
...
![add-grid-tag](browse-solidworks-document-ui/add-grid-tag.png)
...
![add-browse-button](browse-solidworks-document-ui/add-browse-button.png)
...
![add-text-box-tag](browse-solidworks-document-ui/add-text-box-tag.png)
...
![add-open-file-button](browse-solidworks-document-ui/add-open-file-button.png)
...
![add-filepath-property](browse-solidworks-document-ui/add-filepath-property.png)
...
![add-new-folder](browse-solidworks-document-ui/add-new-folder.gif)
...
![add-browsfile-service](browse-solidworks-document-ui/add-browsfile-service.gif)
...
![inherit-from-prism-event](browse-solidworks-document-ui/inherit-from-prism-event.gif)
...
![pass-parameter-to-constructor](browse-solidworks-document-ui/pass-parameter-to-constructor.png)
...
![register-event](browse-solidworks-document-ui/register-event.png)
...
![pass-parameter-to-viewmodel-constructor](browse-solidworks-document-ui/pass-parameter-to-viewmodel-constructor.png)
...
![priavte-event-aggregator-field](browse-solidworks-document-ui/priavte-event-aggregator-field.png)
...
![add-browse-command](browse-solidworks-document-ui/add-browse-command.png)
...
![publish-browse-file-service](browse-solidworks-document-ui/publish-browse-file-service.png)
...
![run-application](browse-solidworks-document-ui/run-application.gif)
