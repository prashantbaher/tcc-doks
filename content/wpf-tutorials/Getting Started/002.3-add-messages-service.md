...
- ***We will continue from previous article 🚀 {{< target-blank "Delete Browse Solidworks Document File" "/wpf-tutorials/delete-browse-file/" >}}.***
...
![add-messageservicefile-service](add-message-service/add-messageservicefile-service.png)


For reference, how to add *Service class*, please visit 🚀 ***{{< target-blank "Add Service for Browsing File Dialog" "/wpf-tutorials/browse-solidworks-document-ui/#add-service-for-browsing-file-dialog/" >}}*** article.
...
![add-services](add-message-service/add-services.png)
...
- For more details on how to add *Services*, please visit 🚀 ***{{< target-blank "Add Service for Browsing File Dialog" "/wpf-tutorials/browse-solidworks-document-ui/#add-service-for-browsing-file-dialog/" >}}*** article.
...
![pass-parameter-to-constructor](add-message-service/pass-parameter-to-constructor.png)
...
- **`BrowseFileDialogService`** is already explained in 🚀 ***{{< target-blank "Understand Service Call Execute Function" "/wpf-tutorials/browse-solidworks-document-ui/#understand-service-call-execute-function/" >}}*** article.

- Please visit 🚀 ***{{< target-blank "Understand Service Call Execute Function" "/wpf-tutorials/browse-solidworks-document-ui/#understand-service-call-execute-function/" >}}*** article for more details.
...
- Please visit 🚀 ***{{< target-blank "MessageBox.Show Method" "https://learn.microsoft.com/en-us/dotnet/api/system.windows.messagebox.show?view=windowsdesktop-7.0" >}}*** article for more details.
...
![add-delete-property](add-message-service/add-delete-property.png)
...
![show-message-for-empty-file](add-message-service/show-message-for-empty-file.png)
...
![browse-file-did-not-exit](add-message-service/browse-file-did-not-exit.png)
...
![final-result](add-message-service/final-result.gif)
