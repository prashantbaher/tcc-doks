...
![add-grid-tag](change-sketch-name-ui/add-grid-tag.png)
...
```xml {lineNos=true hl_lines="18-34"}
...
![add-label](change-sketch-name-ui/add-label.png)
...
```xml {lineNos=true hl_lines="34-40"}
<syncfusion:ChromelessWindow
    x:Class="ChangeSketchName.Views.MainWindow"
    xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
...
![label-in-application](change-sketch-name-ui/label-in-application.png)
...
![add-input-textbox](change-sketch-name-ui/add-input-textbox.png)
...
![add-button-for-change-name](change-sketch-name-ui/add-button-for-change-name.png)
...
![insert-sketch-change-name-button](change-sketch-name-ui/insert-sketch-change-name-button.png)
...
![properties-and-method-required](change-sketch-name-ui/properties-and-method-required.png)
...
![add-property](change-sketch-name-ui/add-property.png)
...
![add-command-in-viewmodel](change-sketch-name-ui/add-command-in-viewmodel.png)
...
![add-code-to-command](change-sketch-name-ui/add-code-to-command.png)
...
![add-property-bindings](change-sketch-name-ui/add-property-bindings.png)
...
![add-command-binding](change-sketch-name-ui/add-command-binding.png)
...
![final-result](change-sketch-name-ui/final-result.gif)
