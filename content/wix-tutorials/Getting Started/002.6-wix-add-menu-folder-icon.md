...
![final-result](wix-add-menu-folder-icon/final-result.gif)
...
![ExampleComponents.wxs-file](wix-add-menu-folder-icon/ExampleComponents.wxs-file.png)
...
```xml {lineNos=true lineNoStart=1 hl_lines="12-16"}
<Wix xmlns="http://wixtoolset.org/schemas/v4/wxs">
  <Fragment>
    <ComponentGroup Id="ApplicationComponents" Directory="INSTALLFOLDER">
...
![add-program-menu-shortcut-tag](wix-add-menu-folder-icon/add-program-menu-shortcut-tag.png)
