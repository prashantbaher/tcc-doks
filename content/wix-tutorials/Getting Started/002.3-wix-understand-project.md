...
In previous 🚀 **{{< target-blank "Wix4 Visual Studio Extension" "/knowledge-base/wix-vs-extension" >}}** article, we created a new Wix V4 project.

Please see below 👇🏻 image of **Visual Studio** for reference.

![wix-project-structure](wix-understand-project/wix-project-structure.png)]
...
![folder.wxs-file](wix-understand-project/folder.wxs-file.png)
...
Please visit 🚀**{{< target-blank "StandardDirectoryType Types" "https://wixtoolset.org/docs/schema/wxs/standarddirectorytype/" >}}** page to get a list of all possible parent directories.
...
![ExampleComponents.wxs-file](wix-understand-project/ExampleComponents.wxs-file.png)
...
[**`Fragment`**] element is same as we discussed 🚀 **{{< target-blank "previously" "/knowledge-base/wix-understand-project/#fragment-element" >}}**.
...
![Package.en-us.wxl-file](wix-understand-project/Package.en-us.wxl-file.png)
...
[**`Culture`**] is the name of a culture following the rules of the 🚀 **{{< target-blank ".NET" "https://learn.microsoft.com/en-us/dotnet/api/system.globalization.cultureinfo#culture-names-and-identifiers" >}}** [**`CultureInfo`**] 🚀 {{< target-blank "class" "https://learn.microsoft.com/en-us/dotnet/api/system.globalization.cultureinfo#culture-names-and-identifiers" >}} which itself follows the Internet standard.
