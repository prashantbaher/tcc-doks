...
![add-remove-msi-details](wix-add-remove-program-details/add-remove-msi-details.png)
...
![add-wpf-project](wix-add-remove-program-details/add-wpf-project.png)
...
![application-logo-file](wix-add-remove-program-details/application-logo-file.png)
...
![reference-wpf-project](wix-add-remove-program-details/reference-wpf-project.png)

Right Click on [**`Dependencies`**] node and select [**`Add Project Reference`**] as shown in below 👇🏻 image.

![select-project-reference](wix-add-remove-program-details/select-project-reference.png)

This will show [**`Reference Manager`**] window as shown in below 👇🏻 image.

![show-reference-manager-window](wix-add-remove-program-details/show-reference-manager-window.png)

Then select [**`CheckBox`**] in front of project you want to add as a [**`Primary Project`**] as shown in below 👇🏻 image.

![select-project-in-reference-manager-window](wix-add-remove-program-details/select-project-in-reference-manager-window.png)
...
![required-variables](wix-add-remove-program-details/required-variables.png)
...
```xml {lineNos=true lineNoStart=1 hl_lines="9-12"}
<!--
...
![package.wxs-file](wix-understand-project/package.wxs-file.png)
...
![updated-package-file](wix-add-remove-program-details/updated-package-file.png)
...
![create-buildversion-variable](wix-add-remove-program-details/create-buildversion-variable.png)
...
![name-property-value](wix-add-remove-program-details/name-property-value.png)
...
![manufacture-property-value](wix-add-remove-program-details/manufacture-property-value.png)
...
![version-property-value](wix-add-remove-program-details/version-property-value.png)
...
![compressed-option](wix-add-remove-program-details/compressed-option.png)
...
![scope-options](wix-add-remove-program-details/scope-options.png)
...
![upgrade-property-value](wix-add-remove-program-details/upgrade-property-value.png)
...
![productcode-property-value](wix-add-remove-program-details/productcode-property-value.png)
...
![major-upgrade-message](wix-add-remove-program-details/major-upgrade-message.png)
...
![cabinet-file](wix-add-remove-program-details/cabinet-file.png)
...
![icon-in-add-remove-program](wix-add-remove-program-details/icon-in-add-remove-program.png)
...
Already explained in previous 🚀 **{{< target-blank "Understand Wix V4 Project" "/knowledge-base/wix-understand-project#feature-element" >}}** article.

---

### [ComponentGroupRef] Element

Already explained in previous 🚀 **{{< target-blank "Understand Wix V4 Project" "/knowledge-base/wix-understand-project#componentgroupref-element" >}}** article.
...
![final-result](wix-add-remove-program-details/final-result.gif)
